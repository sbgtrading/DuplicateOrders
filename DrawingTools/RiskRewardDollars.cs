...
namespace NinjaTrader.NinjaScript.DrawingTools
{
	...
	/// </summary>
	public class RiskRewardDollars : DrawingTool
	{
		...
		public override void OnRender(ChartControl chartControl, ChartScale chartScale)
		{
			...
			{	
				...
				DrawDollarText(RewardAnchor, targetPoint, targetPrice, chartControl, chartPanel, chartScale);
			}
	...
	{
		private static RiskRewardDollars RiskRewardDollarsCore(NinjaScriptBase owner, string tag,
			bool isAutoScale, 
			...
			double ratio, bool isStop, bool isGlobal, string templateName)
		{
			...
			RiskRewardDollars riskReward = DrawingTool.GetByTagOrNew(owner, typeof(RiskRewardDollars), tag, templateName) as RiskRewardDollars;
		...
		/// <returns></returns>
		public static RiskRewardDollars RiskRewardDollars(NinjaScriptBase owner, string tag, bool isAutoScale, DateTime entryTime, double entryY, DateTime endTime, double endY, double ratio, bool isStop)
		{
			return isStop
				? RiskRewardDollarsCore(owner, tag, isAutoScale, int.MinValue, entryTime, entryY, int.MinValue, endTime, endY, 0, Core.Globals.MinDate, 0, ratio, true, false, null)
				: RiskRewardDollarsCore(owner, tag, isAutoScale, int.MinValue, entryTime, entryY, 0, Core.Globals.MinDate, 0, int.MinValue, endTime, endY, ratio, false, false, null);
		}
		...
		/// <param name="isStop">A bool value, when true will use the endTime/endBarsAgo and endY to set the stop, and will automatically calculate the target based off the ratio value.</param>
		/// <returns></returns>
		public static RiskRewardDollars RiskRewardDollars(NinjaScriptBase owner, string tag, bool isAutoScale, int entryBarsAgo, double entryY, int endBarsAgo, double endY, double ratio, bool isStop)
		{
			return isStop
				? RiskRewardDollarsCore(owner, tag, isAutoScale, entryBarsAgo, Core.Globals.MinDate, entryY, endBarsAgo, Core.Globals.MinDate, endY, 0, Core.Globals.MinDate, 0, ratio, true, false, null)
				: RiskRewardDollarsCore(owner, tag, isAutoScale, entryBarsAgo, Core.Globals.MinDate, entryY, 0, Core.Globals.MinDate, 0, endBarsAgo, Core.Globals.MinDate, endY, ratio, false, false, null);
		}
		...
		/// <returns></returns>
		public static RiskRewardDollars RiskRewardDollars(NinjaScriptBase owner, string tag, bool isAutoScale, DateTime entryTime, double entryY, DateTime endTime, double endY, double ratio, bool isStop, bool isGlobal, string templateName)
		{
			return isStop
				? RiskRewardDollarsCore(owner, tag, isAutoScale, int.MinValue, entryTime, entryY, int.MinValue, endTime, endY, 0, Core.Globals.MinDate, 0, ratio, true, isGlobal, templateName)
				: RiskRewardDollarsCore(owner, tag, isAutoScale, int.MinValue, entryTime, entryY, 0, Core.Globals.MinDate, 0, int.MinValue, endTime, endY, ratio, false, isGlobal, templateName);
		}
		...
		/// <param name="templateName">The name of the drawing tool template the object will use to determine various visual properties</param>
		/// <returns></returns>
		public static RiskRewardDollars RiskRewardDollars(NinjaScriptBase owner, string tag, bool isAutoScale, int entryBarsAgo, double entryY, int endBarsAgo, double endY, double ratio, bool isStop, bool isGlobal, string templateName)
		{
			return isStop
				? RiskRewardDollarsCore(owner, tag, isAutoScale, entryBarsAgo, Core.Globals.MinDate, entryY, endBarsAgo, Core.Globals.MinDate, endY, 0, Core.Globals.MinDate, 0, ratio, true, isGlobal, templateName)
				: RiskRewardDollarsCore(owner, tag, isAutoScale, entryBarsAgo, Core.Globals.MinDate, entryY, 0, Core.Globals.MinDate, 0, endBarsAgo, Core.Globals.MinDate, endY, ratio, false, isGlobal, templateName);
		}
	}
}